...
public final class Constants {
    ...
    public static final String C_HAS_DIRECTORY = "has_directory";
    ...
    public static final String T_TORRENT_CREATE = "CREATE TABLE "
        ...
        + C_HAS_DIRECTORY + " INTEGER NOT NULL DEFAULT 0, "
    ...
    public static class ColumnGroups {
        public static final String[] TORRENT_OVERVIEW = {
            ...
            C_UPLOAD_RATIO, C_SEED_RATIO_LIMIT, C_SEED_RATIO_MODE, C_HAS_DIRECTORY,
